...
<section class="section-slide">
	<div class="wrap-slick1 rs2-slick1">
		<div class="slick1">
			<div class="item-slick1 bg-overlay1" style="background-image:;" data-thumb="pic/a.jpg" >
			...
			<div class="item-slick1 bg-overlay1" style="background-image: url(images/1122.jpg);"data-caion="Meptn’s Wear">
				<div class="container h-full">
					<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
			...
			<div class="item-slick1 bg-overlay1" style="background-image: url(images/23.jpg);" data-thumb= data-caption=" Men’sWear">
				<div class="container h-full">
					<div class="flex-col-c-m h-full p-t-100 p-b-60 respon5">
